...
<head>
    ...
    <title> LE-EN ➢ DASHBOARD - Gestionar alumnos</title>
        ...
        <div class="boxed">
            ...
            <div id="content-container">
                <div id="page-head">
					...
					<li class="active"><a href="../gestion_alumnos/eliminar_alumno.php">GESTION DE ALUMNOS   </a> <i class="fas fa-chevron-right"></i> GESTIONAR ALUMNOS</li>
                    </ol>
                    <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
                    <!--End breadcrumb-->
...
$consulta = $mysql->efectuarConsulta("SELECT COUNT(englispage.miembros.id) as 'id' from englispage.miembros 
                                    where englispage.miembros.miembros_rol_fk = 2");
...
<div class="pad-all">
                                    <span class="pad-ver text-main text-sm text-uppercase text-bold centrar-total-std">Total de Alumnos</span>
                                    ...
                                    <button class="btn btn-block btn-info mar-top "><a href="#" style="color: white;">ver Alumnos</a></button>
                                </div>
...
where englispage.miembros.miembros_rol_fk = 2  order by  englispage.miembros.id asc ");
                                            ...
                                            <tbody>
					                            ...
					                            <tr>
					                                ...
					                                <td class="text-center">
					                                    <div class="btn-group">
					                                        <a class="btn btn-sm btn-default btn-hover-success fa fa-wrench add-tooltip" onclick="location.href='actualizar_alumno.php?id=<?php echo $row['id']?>';" data-original-title="Editar" data-container="body"></a>
					                                        <a class="btn btn-sm btn-default btn-hover-danger fa fa-user-times add-tooltip" href="../controladordashboard/eliminaralumno.php?id=<?php echo $row['id']?>" onclick="return confirm('¿Está seguro que desea eliminar este registro?');" data-original-title="Eliminar" data-container="body"></a>
					                                        <a class="btn btn-sm btn-default btn-hover-success fa fa-user-plus add-tooltip" onclick="location.href='agregar_alumno.php?id=<?php echo $row['id']?>';"  data-original-title="Agregar" data-container="body"></a>
                                ...
                                <ul id="mainnav-menu" class="list-group">
						            ...
						            <li>
                                     ...
                                     <li>
						                ...
						                <!--Submenu-->
						                <ul class="collapse">
											<li><a href="eliminar_alumno.php">Gestionar alumnos</a></li>
											<li class="list-divider"></li>
