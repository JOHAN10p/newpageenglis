...
<head>
    ...
    <title> LE-EN ➢ DASHBOARD - AGREGAR ALUMNO</title>
    ...
    <link rel="stylesheet" type="text/css" href="style_agregaralumno.css">
        ...
        <div class="boxed">
            ...
            <div id="content-container">
                <div id="page-head">
					...
					<li class="active"><a href="../gestion_alumnos/eliminar_alumno.php">GESTION DE ALUMNOS   </a> <i class="fas fa-chevron-right"></i>  AGREGAR ALUMNO</li>
                    </ol>
                    <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
                    <!--End breadcrumb-->
