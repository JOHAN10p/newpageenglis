...
<head>
    ...
    <title> LE-EN ➢ DASHBOARD - AGREGAR DOCENTE</title>
        ...
        <div class="boxed">
            ...
            <div id="content-container">
                <div id="page-head">
					...
					<li class="active"><a href="../gestion_docentes/eliminar_docente.php">GESTION DE DOCENTES   </a> <i class="fas fa-chevron-right"></i>  AGREGAR DOCENTES</li>
                    </ol>
                    <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
                    <!--End breadcrumb-->
...
<div class="divform">             
  ...
  <form class="form" action="../controladordashboard/creardocente.php" method="POST"> 
    ...
    <p> USUARIO : <br>
    <input class="inputo" type="text" name="usuario" required >
    </p>
    
    <p> CORREO : <br>
    <input class="inputo" type="email" name="correo" required >
    </p>
    
    <p> CONTRASEÑA : <br>
    <input class="inputo" type="password"  name="contraseña" minlength="8" required >
    </p>
                                ...
                                <ul id="mainnav-menu" class="list-group">
						            ...
						            <li>
                                     ...
                                     <li>
						                ...
						                <!--Submenu-->
                                        <ul class="collapse">
											<li><a href="eliminar_docente.php">Gestionar docentes</a></li>
											<li class="list-divider"></li>
