...
<head>
    ...
    <title> LE-EN ➢ DASHBOARD - ACTUALIZAR DOCENTES</title>
    ...
    <!--stylecss-->
    <link rel="stylesheet" href="../gestion_alumnos/style_agregaralumno.css">
        ...
        <div class="boxed">
            ...
            <div id="content-container">
                <div id="page-head">
					...
					<li class="active"><a href="../gestion_docentes/eliminar_docente.php">GESTION DE DOCENTES  </a> <i class="fas fa-chevron-right"></i>  ACTUALIZAR DOCENTES</li>
                    </ol>
                    <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
                    <!--End breadcrumb-->
...
<head>
    <!-- se crea la etiqueta meta para decirle que acepte acentos o tildes -->
	<meta charset="utf-8">
...
<form class="form" action="../controladordashboard/actualizardocente.php" method="POST" enctype="multipart/form-data">
                                ...
                                <ul id="mainnav-menu" class="list-group">
						            ...
						            <li>
                                     ...
                                     <li>
						                ...
						                <!--Submenu-->
                                        <ul class="collapse">
											<li><a href="eliminar_docente.html">Gestionar Docentes</a></li>
											<li class="list-divider"></li>
