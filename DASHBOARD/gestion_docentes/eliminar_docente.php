...
<head>
    ...
    <title> LE-EN ➢ DASHBOARD - GESTIONAR DOCENTES</title>
        ...
        <div class="boxed">
            ...
            <div id="content-container">
                <div id="page-head">
					...
					<li class="active"><a href="../gestion_docentes/eliminar_docente.php">GESTION DE DOCENTES   </a> <i class="fas fa-chevron-right"></i>  GESTIONAR DOCENTES</li>
                    </ol>
                    <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
                    <!--End breadcrumb-->
...
<div class="pad-all">
                                    <span class="pad-ver text-main text-sm text-uppercase text-bold centrar-total-std">Total de Docentes</span>
                                    ...
                                    <button class="btn btn-block btn-info mar-top "><a href="#" style="color: white;">ver Docentes</a></button>
                                </div>
...
where englispage.miembros.miembros_rol_fk = 3  order by  englispage.miembros.id asc ");
					                    ...
					                    <table class="table table-vcenter mar-top">
                                            ...
                                            <tbody>
					                            <tr>
                                                    ...
                                                    <td><a href="#" target="_blank"><img src="../img\profile-photos\3.png" alt="Profile Picture" class="img-circle img-sm"></a></td>
					                                ...
					                                <td class="text-center">
					                                    <div class="btn-group">
					                                        <a class="btn btn-sm btn-default btn-hover-success fa fa-wrench add-tooltip" onclick="location.href='actualizar_docente.php?id=<?php echo $row['id']?>';" data-original-title="Editar" data-container="body"></a>
					                                        <a class="btn btn-sm btn-default btn-hover-danger fa fa-user-times add-tooltip" href="../controladordashboard/eliminardocente.php?id=<?php echo $row['id']?>" onclick="return confirm('¿Está seguro que desea eliminar este docente?');" data-original-title="Eliminar" data-container="body"></a>
					                                        <a class="btn btn-sm btn-default btn-hover-success fa fa-user-plus add-tooltip" onclick="location.href='agregar_docente.php?id=<?php echo $row['id']?>';"  data-original-title="Agregar" data-container="body"></a>
