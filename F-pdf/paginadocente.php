...
<center><a href="generardoce.php"><button type="button" class="btn btn-success">EXCEL</button></a></center><br>
<center><a href="reportedocentes.php"><button type="button" class="btn btn-danger">PDF</button></a></center>
