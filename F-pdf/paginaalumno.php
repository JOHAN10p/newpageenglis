...
<center><a href="generaralum.php"><button type="button" class="btn btn-success">EXCEL</button></a></center><br>
<center><a href="reportealumno.php"><button type="button" class="btn btn-danger">PDF</button></a></center>
